...
<body>
	<div class="container">
		Create account
		<form name="joinForm" class="was-validated" role="form" action="/member/join" method="post">
			...
			<div class="a-row a-spacing-base">
				...
				<button type="button" onclick="joinCheck();" class="btn btn-primary">Create your Amazon account</button>
			</form>
	</div>
	<!-- /container -->
</body>
